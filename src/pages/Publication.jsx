...
const Publication = () => {
  return (
    <div className='flex justify-center items-center'>
      <div className='w-9/12 h-auto flex flex-col mt-36 mb-24'>
        <h1 className='text-4xl text-green-850 text-bold mb-12 text-left m-0'>
          PUBLICATIONS
        </h1>
        <div className='w-full h-auto flex flex-col'>
          <h2 className='text-xl text-green-850 sub-heading sub-heading rounded-sm'>
            KIPA
          </h2>
          <div className='w-full flex flex-col md:h-auto sm:flex-row justify-evenly sm:justify-start mt-6 sm:flex-wrap'>
            {publications.map(({ id, name, link }) => {
              return (
                <div
                  key={id}
                  className='w-full h-auto p-2 flex flex-col items-center md:mt-0 md:w-1/2'
                >
                  <a
                  ...
                  >
                    <svg
                      className='h-32 w-32 mb-4 md:h-20 md:w-20'
                      version='1.1'
                      id='Layer_1'
